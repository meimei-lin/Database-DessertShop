...
<div id="container">
	<ul class="parent" style="left: 0;">
		<li><img src="public/img/d1.jpg"></li>
		<li><img src="public/img/d1-1.jpg"></li>
...
btnLeft.onclick = function() {
	...
	if(imgLeft === "0px") { /*当是第1张时，每张图片左移，移4张图，位置为-(4*500)*/
		...
		left = parseInt(imgLeft) + 350; /*由于left为负数，每左移一张加500*/
	}
...
btnRight.onclick = function() {
	...
	if(imgLeft === "-2000px") { /*当是第5张时，第1张的位置为0*/
		...
		right = parseInt(imgLeft) - 350; /*由于left为负数，每右移一张减500*/
	}
