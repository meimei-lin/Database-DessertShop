...
<table width="60%"  border=5px>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="text" name="name"  style="font-size:20px;width:300px;height:50px" value='<?php echo $row['name']?>'></td>
               ...
               <input type="submit" name="edit_class" value="修改分類名稱" style="font-size:20px;position:absolute;left:1050px;bottom:450px;background-color:#FFBFFF;color:#454545;width:200px;height:50px;">
</form>
</div> 
</div>
</div>
