...
<table width="60%"  border=5px>
                    ...
                    <tr>
                        <td align="center"><font size=5>分類名稱:</font></td>
                        <td align="center"><input type="text" name="name" style="font-size:20px;width:300px;height:50px"></td>
                        
                    </tr>
                </table>
               <input type="submit" name="add_class" value="添加分類" style="font-size:20px;position:absolute;left:1000px;bottom:400px;background-color:#FFBFFF;color:#454545;width:200px;height:50px;">
</form>
</div> 
</div>
</div>
