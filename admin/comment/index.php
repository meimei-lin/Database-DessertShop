...
<div class="item">
    ...
    <div id="i4" class="content hid">
        <p><a href='index.php' target="right">查看留言</a></p>
    </div>
</div>
<div class="item">
...
$sql="select comment.*,user.username,shop.name from comment,shop,user where comment.user_id=user.id and comment.shop_id=shop.id";
