...
<table width="60%"  border=5px>
        ...
        <tr>
            <td align="center"><font size=5>商品名稱:</font></td>
            <td align="center"><input type="text" name="name"  style="font-size:20px;width:300px;height:50px"></td>
        </tr>
        <tr>
            <td align="center"><font size=5>價錢:</font></td>
            <td align="center"><input type="int" name="price"  style="font-size:20px;width:300px;height:50px"></td>
        </tr>
        <tr>
            <td align="center"><font size=5>庫存:</font></td>
            <td align="center"><input type="int" name="stock"  style="font-size:20px;width:300px;height:50px"></td>
        </tr>
        <tr>
            <td align="center"><font size=5>分類:</font></td>
            <td align="center">
        ...
        <tr>
            <td align="center"><font size=5>上下架:</font></td>
            <td align="center">
            <label>
            <input type="radio" name="shelf" value='1' style="font-size:30px;" checked>上架
            </label>
            <label>
            <input type="radio" name="shelf" value='0' style="font-size:30px;">下架
            </label>
            </td>
            <tr>
                <td align="center"><font size=5>圖片:</font></td>
                <td align="center"><input type="file" name="img"  style="font-size:20px;width:300px;height:50px"></td>
            </tr>
    </table>
        <input type="submit" name="register" value="添加商品" style="font-size:20px;position:absolute;left:1000px;bottom:180px;background-color:#FFBFFF;color:#454545;width:200px;height:50px;">
</form>
</div> 
</div>
</div>
