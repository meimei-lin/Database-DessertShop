...
<table width="60%"  border=5px>
    <tr>
        ...
        <tr>
            <td align="center"><font size=5>修改訂單編號:</font></td>
            <td align="center"><input type="int" name="code"  style="font-size:20px;width:300px;height:50px" value='<?php echo $code?>'></td>
        </tr>
        <tr>
            <td align="center"><font size=5>修改訂單狀態:</font></td>
            <td align="center">
                <select name="status_id" style="font-size:20px;">
                    <?php
    ...
    <input type="submit" name="shop" value="修改訂單資訊" style="font-size:20px;position:absolute;left:1050px;bottom:400px;background-color:#FFBFFF;color:#454545;width:200px;height:50px;">
</form>
</div> 
</div>
</div>
