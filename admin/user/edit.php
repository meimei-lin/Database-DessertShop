...
<div class="head" onclick="showMenu('i1')">會員管理</div>
        <div id="i1" class="content hid" >
            <p><a href='index.php' target="right">查看會員</a></p>
            <p><a href='add.php' target="right">添加會員</a></p>
        </div>
</div>
<div class="item">
...
<table width="60%"  border=5px>
                    ...
                    <tr>
                        <td align="center"><font size=5>會員姓名:</font></td>
                        <td align="center"><input type="text" name="username" placeholder="輸入會員姓名" style="font-size:20px;width:300px;height:50px" value='<?php echo $row['username']?>'></td>
                    ...
                    <tr>
                        <td align="center"><input type="hidden" name="id" value='<?php echo $row['id']?>'></td>
                    </tr>
                </table>
               <input type="submit" name="register" value="修改會員資料" style="font-size:20px;position:absolute;left:1000px;bottom:400px;background-color:#FFBFFF;color:#454545;width:200px;height:50px;">
</form>
</div> 
</div>
</div>
