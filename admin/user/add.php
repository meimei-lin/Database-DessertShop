...
<table width="60%"  border=5px>
                    ...
                    <tr>
                        ...
                        <td align="center"><input type="text" name="username" placeholder="輸入會員姓名" style="font-size:20px;width:300px;height:50px"></td>
               ...
               <input type="submit" name="register" value="添加會員" style="font-size:20px;position:absolute;left:1000px;bottom:400px;background-color:#FFBFFF;color:#454545;width:200px;height:50px;">
</form>
</div> 
</div>
</div>
