...
<table width="60%"  border=5px>
               ...
               <input type="submit" name="edit_class" value="修改狀態" style="font-size:20px;position:absolute;left:1050px;bottom:450px;background-color:#FFBFFF;color:#454545;width:200px;height:50px;">
</form>
</div> 
</div>
</div>
