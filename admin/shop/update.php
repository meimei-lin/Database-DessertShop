...
if($imgerror === 0){
    ...
    if(move_uploaded_file($src,$dst)){
        ...
        $sql="update shop set name='{$sname}',price='{$price}',stock='{$stock}',shelf='{$shelf}',class_id='{$class_id}',img='{$img}' where id={$id}";
        ...
        $sql="update shop set name='{$sname}',price='{$price}',stock='{$stock}',shelf='{$shelf}',class_id='{$class_id}' where id={$id}";
